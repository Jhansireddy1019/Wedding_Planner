...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="#about"> <i class="fas fa-chevron-right"></i> vendor </a>
            <a href="#services"> <i class="fas fa-chevron-right"></i> clients </a>
            <a href="#doctors"> <i class="fas fa-chevron-right"></i> team </a>
            <a href="#appointment"> <i class="fas fa-chevron-right"></i> blog </a>
            <a href="#review"> <i class="fas fa-chevron-right"></i> contact </a>
            <a href="/login/logout.php"> <i class="fas fa-chevron-right"></i> logout </a>
        </div>

        <div class="box">
            <h3>our services</h3>
            <a href="#"> <i class="fas fa-chevron-right"></i> Engagement </a>
            <a href="#"> <i class="fas fa-chevron-right"></i> Pre Wedding Shoot </a>
            <a href="#"> <i class="fas fa-chevron-right"></i> Haldi </a>
            <a href="#"> <i class="fas fa-chevron-right"></i> Post Wedding shoot </a>
            <a href="#"> <i class="fas fa-chevron-right"></i> Reception </a>
        </div>

        <div class="box">
            <h3>appointment info</h3>
            <a href="#"> <i class="fas fa-phone"></i> +8808938801 </a>
            <a href="#"> <i class="fas fa-phone"></i> +8782546978 </a>
            <a href="#"> <i class="fas fa-envelope"></i> jhansireddy@gmail.com </a>
            <a href="#"> <i class="fas fa-envelope"></i> reddyjhansi832@gmail.com </a>
            <a href="#"> <i class="fas fa-map-marker-alt"></i> Banglore </a>
        </div>

        <div class="box">
            <h3>follow us</h3>
            <a href="#"> <i class="fab fa-faceappointment-f"></i> face appointment </a>
...
<div class="footer"> created by <span>Jhansi Reddy</span> | all rights reserved! </div>
